...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-neutral-200 bg-white/85 backdrop-blur-md dark:border-neutral-800 dark:bg-neutral-950/80">
      ...
      >
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="ml-1 inline-flex h-9 w-9 items-center justify-center rounded-md text-neutral-600 transition-colors hover:bg-neutral-100 hover:text-neutral-900 sm:hidden dark:text-neutral-400 dark:hover:bg-neutral-800 dark:hover:text-white"
          >
            {mobileOpen ? (
      ...
      {mobileOpen && (
        <div className="border-t border-neutral-200 bg-white/95 px-4 py-3 backdrop-blur-md sm:hidden dark:border-neutral-800 dark:bg-neutral-950/95">
          <Link
            href="/about"
            onClick={() => setMobileOpen(false)}
            className="flex items-center gap-2 rounded-md px-2 py-2.5 text-sm text-neutral-700 transition-colors hover:bg-neutral-100 hover:text-neutral-900 dark:text-neutral-300 dark:hover:bg-neutral-800 dark:hover:text-white"
          >
            About
          </Link>
          <a
